...
for filename in os.listdir(directory):
    ...
    single_command = []
    single_command.append("python3")
    single_command.append("/Users/titashneogi/workspace/sky/sky/sky/c2.py")
    single_command.append(fullpath)
    command_array.append(single_command)
